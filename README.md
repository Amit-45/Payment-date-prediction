...
- [Storing the Dataset into the Dataframe](#storing-the-dataset-into-the-dataframe)
- [Checking the Shape of the Dataframe](#checking-the-shape-of-the-dataframe)
- [Checking the Detail Information of the Dataframe](#checking-the-detail-information-of-the-dataframe)
- [Displaying All the Column Names](#displaying-all-the-column-names)
- [Describing the Entire Dataset](#describing-the-entire-dataset)
- [Data Cleaning](#data-cleaning)
- [Showing Top 5 Records from the Dataset](#showing-top-5-records-from-the-dataset)
- [Data Type Conversion](#data-type-conversion)
- [Splitting the Dataset](#splitting-the-dataset)
- [Splitting the Train and Test Data](#splitting-the-train-and-test-data)
- [Exploratory Data Analysis (EDA)](#exploratory-data-analysis-eda)
- [Feature Engineering](#feature-engineering)
- [Feature Selection](#feature-selection)
- [Modeling](#modeling)
- [Comparing Different Machine Learning Models](#comparing-different-machine-learning-models)
  - Linear Regression
